  ...
  return (
    <div>
      <h1 className="sr-only">
        Hello We Are The Free Moroccans, Fighting For The Cultural Freedom Of Our Country, For A Better Future.
      </h1>
      <motion.div
